...
namespace EnsureThat
{
    public static partial class EnsureArg
    {
        ...
        public static int IsPositive(int value, [InvokerParameterName] string paramName = null, OptsFn optsFn = null) 
            => Ensure.Comparable.IsPositive(value, paramName, optsFn);

        public static int IsNegative(int value, [InvokerParameterName] string paramName = null, OptsFn optsFn = null)
            => Ensure.Comparable.IsNegative(value, paramName, optsFn);

        public static int IsNotNegative(int value, [InvokerParameterName] string paramName = null, OptsFn optsFn = null)
