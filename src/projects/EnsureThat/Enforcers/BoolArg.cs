...
namespace EnsureThat.Enforcers
{
    ...
    public sealed class BoolArg
    {
        ...
        public bool IsTrue(bool value, [InvokerParameterName, CallerArgumentExpression(nameof(value))] string paramName = null)
        {
            if (!value)
        ...
        public bool IsFalse(bool value, [InvokerParameterName, CallerArgumentExpression(nameof(value))] string paramName = null)
        {
            if (value)
