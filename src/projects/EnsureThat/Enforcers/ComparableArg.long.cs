...
namespace EnsureThat.Enforcers
{
    ...
    {
        public long Is(long value, long expected, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value != expected)
        ...
        public long IsNot(long value, long expected, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value == expected)
                throw Ensure.ExceptionFactory.ArgumentException(
        ...
        public long IsLt(long value, long limit, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value >= limit)
        ...
        public long IsLte(long value, long limit, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value > limit)
                throw Ensure.ExceptionFactory.ArgumentOutOfRangeException(
        ...
        public long IsGt(long value, long limit, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value <= limit)
                throw Ensure.ExceptionFactory.ArgumentOutOfRangeException(
        ...
        public long IsGte(long value, long limit, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value < limit)
                throw Ensure.ExceptionFactory.ArgumentOutOfRangeException(
        ...
        public long IsInRange(long value, long min, long max, [InvokerParameterName, CallerArgumentExpression("value")] string paramName = null)
        {
            if (value < min)
                throw Ensure.ExceptionFactory.ArgumentOutOfRangeException(
