...
namespace UnitTests
{
    public class EnsureStringParamTests : UnitTestBase
    {
        ...
        public class IsNotNull : UnitTestBase
        {
            [Fact]
            ...
            [Fact]
            public void WhenStringIsNotNull_It_should_not_throw()
            {
        ...
        public class IsNotNullOrEmpty : UnitTestBase
        {
            [Fact]
            public void WhenStringIsNull_ThrowsArgumentNullException()
            {
            ...
            [Fact]
            public void WhenStringIsNotNullOrEmpty_It_should_not_throw()
            {
                var value = " ";
        ...
        public class IsNotNullOrWhiteSpace : UnitTestBase
        {
            [Fact]
            public void WhenStringIsNull_ThrowsArgumentNullException()
            {
            ...
            [InlineData("")]
            [InlineData(" ")]
            public void WhenStringIsInvalid_ThrowsArgumentException(string value)
            {
            ...
            [Fact]
            public void WhenStringHasValue_It_should_not_throw()
            {
                var value = "delta";
        ...
        public class IsNotEmpty : UnitTestBase
        {
            [Fact]
            public void WhenStringIsEmpty_ThrowsArgumentException()
            {
            ...
            [Fact]
            public void WhenStringIsNull_It_should_not_throw()
            {
                string value = null;
        ...
        public class HasLengthBetween : UnitTestBase
        {
            [Fact]
            public void WhenStringIsNull_ThrowsArgumentNullException()
            {
            ...
            [Fact]
            public void WhenStringIsToShort_ThrowsArgumentException()
            {
                const int low = 2;
                const int high = 4;
            ...
            [Fact]
            public void WhenStringIsToLong_ThrowsArgumentException()
            {
                const int low = 2;
                const int high = 4;
            ...
            [Fact]
            public void WhenStringIsLowLimit_It_should_not_throw()
            {
                const int low = 2;
                const int high = 4;
            ...
            [Fact]
            public void WhenStringIsHighLimit_It_should_not_throw()
            {
                const int low = 2;
                const int high = 4;
        ...
        public class Matches : UnitTestBase
        {
            [Fact]
            public void WhenUrlStringDoesNotMatchStringPattern_ThrowsArgumentException()
            {
            ...
            [Fact]
            public void WhenUrlStringDoesNotMatchRegex_ThrowsArgumentException()
            {
                const string value = @"incorrect";
            ...
            [Fact]
            public void WhenUrlStringMatchesStringPattern_It_should_not_throw()
            {
            ...
            [Fact]
            public void WhenUrlStringMatchesRegex_It_should_not_throw()
            {
                const string value = @"http://google.com:8080";
                var match = new Regex(@"(?<Protocol>\w+):\/\/(?<Domain>[\w@][\w.:@]+)\/?[\w\.?=%&=\-@/$,]*");
        ...
        public class SizeIs : UnitTestBase
        {
            [Fact]
            public void When_null_It_throws_ArgumentNullException()
            {
                string value = null;
                var expected = 1;
            ...
            [Fact]
            public void When_non_matching_length_of_string_It_throws_ArgumentException()
            {
            ...
            [Fact]
            public void When_matching_constraint_It_should_not_throw()
            {
                var value = "Some string";
        ...
        public class IsEqualTo : UnitTestBase
        {
            [Fact]
            public void When_different_values_It_throws_ArgumentException()
            {
            ...
            [Fact]
            public void When_same_value_It_should_not_throw()
            {
                const string value = "The value";
            ...
            [Fact]
            public void When_same_value_by_specific_compare_It_should_not_throw()
            {
                const string value = "The value";
        ...
        public class IsNotEqualTo : UnitTestBase
        {
            [Fact]
            public void When_same_values_It_throws_ArgumentException()
            {
                const string value = "The value";
            ...
            [Fact]
            public void When_different_values_by_casing_using_non_case_sensitive_compare_It_throws_ArgumentException()
            {
                const string value = "The value";
            ...
            [Fact]
            public void When_different_values_It_should_not_throw()
            {
                var value = "The value";
            ...
            [Fact]
            public void When_different_values_by_casing_using_case_sensitive_compare_It_should_not_throw()
            {
                var value = "The value";
        ...
        public class IsGuid : UnitTestBase
        {
            [Fact]
            public void When_null_It_should_not_throw_ArgumentNullException()
            {
                string value = null;
            ...
            [Fact]
            public void When_null_It_should_throw_ArgumentException()
            {
                string value = null;
            ...
            [Fact]
            public void When_is_not_Guid_throws_ArgumentException()
            {
            ...
            [Fact]
            public void When_valid_Guid_returns_Guid()
            {
