...
[![Build Status](https://dev.azure.com/danielwertheim/ensure.that/_apis/build/status/danielwertheim.Ensure.That)](https://dev.azure.com/danielwertheim/ensure.that/_build/latest)
